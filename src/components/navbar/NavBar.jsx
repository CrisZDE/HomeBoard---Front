    ...
    return(
        ...
        <div className="max-w-[90rem] h-20 flex m-auto justify-between">
            ...
            <button onClick={() => navigate('/createform')}>
                <img src="/assets/subir-idea.svg" alt="Crear Idea" className="w-6" />
            </button>
            {isPublicDash ? (
                    <button onClick={() => navigate('/user')}>
                        <img src="/assets/circulo-de-usuario.svg" alt="Ir al dashboard del usuario" className="w-8" />
                    </button>
                ) : (
                    <button onClick={goToLogout}>
                        <img src="/assets/Logout_Icon.svg" alt="Salir de la aplicación" className="w-8" />
                    </button>
                )}
